 ...
 //PHONENUMBER   	
	...
	public ArrayList<Subscriber> makeSearch(DictReqForm dictReqForm){
		...
		if(this.isNotEmpty(dictReqForm.getLastName())){
			criteria.add(Restrictions.eq("subscrLastName", dictReqForm.getLastName()));
		}	
		if(this.isNotEmpty(dictReqForm.getFirstName())){
			criteria.add(Restrictions.eq("subscrFirstName", dictReqForm.getFirstName()));
		}
		if(this.isNotEmpty(dictReqForm.getDepartament())){
			criteria.add(Restrictions.eq("departament", dictReqForm.getDepartament()));
		}
	...
	public  void addPhone(SubscriberType subsType, Subscriber subs, PhoneType phoneType){
